<%@ Page Title="Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Patient_Feedback.Details" %>
...
<body>
    <header>
        <div class="Headcontent">
            ...
            <h1>!!आईपीडी प्रतिपुष्टि प्रपत्र</h1>
        </div>
    </header>
        ...
        <div class="contener">
            ...
            <div class="form-container">
                ...
                <div class="form-button-container">
                    <asp:Button ID="Button1" runat="server" Text="Proceed Next" CssClass="form-button btn btn-primary mt-2" OnClick="ButtonIPDdetail_Click" />
                </div>
            </div>
        </div>
    </div>
